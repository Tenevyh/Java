...
public class Solution {
    ...
    public static Pair getMinimumMaximumPair(int[] inputArray) {
        ...
        Optional<Integer> x=Arrays.stream(inputArray).boxed().sorted((o1, o2) -> o1-o2).findFirst();
        Optional<Integer> y=Arrays.stream(inputArray).boxed().sorted((o1, o2) -> o2-o1).findFirst();

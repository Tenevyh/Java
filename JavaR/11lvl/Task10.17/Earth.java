...
public class Earth {
    public static void main(String[] args) {
        Antarctica a=new Antarctica(6);
        Australia b=new Australia(5);
        NorthAmerica c=new NorthAmerica(4);
        SouthAmerica d=new SouthAmerica(3);
        Eurasia e=new Eurasia(2);
        Africa f=new Africa(1);
    }

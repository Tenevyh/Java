...
public class Solution {
    ...
    public static String toHex(String binaryNumber) {
        ...
        if (binaryNumber.length() % 4==1) {
            temp.append("000").append(binaryNumber);//null+"000"+100111010000
        }else if(binaryNumber.length()%4==2) {
            temp.append("00").append(binaryNumber);//null+"00"+100111010000
        }else if(binaryNumber.length()%4==3) {
            temp.append("0").append(binaryNumber);//null+"0"+100111010000
        }else {
